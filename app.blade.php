    ...
    <footer class="text-center text-lg-start bg-light text-muted">
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-phone me-3"></i> +84 987654321</p>
                    </div>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2026 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp; Nguyễn Văn Hoàng</a>
                </span>
            </div>
        </section>
    </footer>
